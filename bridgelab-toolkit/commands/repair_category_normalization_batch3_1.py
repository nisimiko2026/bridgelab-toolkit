"""CLI for the reviewed Phase 3A category normalization Batch 3.1."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_category_normalization_batch3_1_report(root)
    ...
    apply_category_normalization_batch3_1_report(report, root, backup)
