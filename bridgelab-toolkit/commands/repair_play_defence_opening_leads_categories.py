"""CLI for the reviewed ten-file defence opening-leads category batch."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_defence_opening_leads_category_report(root)
    ...
    apply_play_defence_opening_leads_category_report(report, root, backup)
