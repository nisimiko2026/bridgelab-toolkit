"""CLI for the reviewed three-file declarer-endplays category batch."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_endplays_category_report(root)
    ...
    apply_play_endplays_category_report(report, root, backup)
