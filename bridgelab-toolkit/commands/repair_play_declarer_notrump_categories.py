"""CLI for the reviewed eight-file declarer-notrump category batch."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_declarer_notrump_category_report(root)
    ...
    apply_play_declarer_notrump_category_report(report, root, backup)
