"""CLI for the reviewed Phase 3A category normalization Batch 3.3x."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_category_normalization_batch3_3x_report(root)
    ...
    apply_category_normalization_batch3_3x_report(report, root, backup)
