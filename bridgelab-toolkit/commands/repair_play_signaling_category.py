"""CLI for the reviewed play defence-signaling category repair."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_signaling_category_report(root)
    ...
    apply_play_signaling_category_report(report, root, backup)
