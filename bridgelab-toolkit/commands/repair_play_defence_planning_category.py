"""CLI for the reviewed defence-planning index category repair."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_defence_planning_category_report(root)
    ...
    apply_play_defence_planning_category_report(report, root, backup)
