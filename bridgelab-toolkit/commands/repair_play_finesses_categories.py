"""CLI for the reviewed seven-file declarer-finesses category batch."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_finesses_category_report(root)
    ...
    apply_play_finesses_category_report(report, root, backup)
