"""CLI reporting for the reviewed play defence-endgame category repair."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_endgame_category_report(root)
    ...
    apply_play_endgame_category_report(report, root, backup)
