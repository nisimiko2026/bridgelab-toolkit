"""CLI for the reviewed Phase 3A category normalization Batch 3.3o."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_category_normalization_batch3_3o_report(root)
    for action in report.actions:
        subcategory, _ = REVIEWED_CATEGORY_NORMALIZATION_BATCH3_3O[action.article]
        typer.echo(
    ...
    apply_category_normalization_batch3_3o_report(report, root, backup)
