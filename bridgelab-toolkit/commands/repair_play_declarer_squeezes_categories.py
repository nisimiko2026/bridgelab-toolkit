"""CLI for the reviewed ten-file declarer-squeezes category batch."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_declarer_squeezes_category_report(root)
    ...
    apply_play_declarer_squeezes_category_report(report, root, backup)
