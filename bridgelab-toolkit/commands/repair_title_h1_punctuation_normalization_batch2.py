"""CLI for Phase 4B Batch 2 punctuation-only metadata-title normalization."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_title_h1_punctuation_normalization_batch2_report(root)
    ...
    apply_title_h1_punctuation_normalization_batch2_report(report, root, backup)
