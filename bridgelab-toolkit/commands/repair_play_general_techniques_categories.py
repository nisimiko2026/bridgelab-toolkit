"""CLI for the reviewed three-file declarer general-techniques category batch."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_general_techniques_category_report(root)
    ...
    apply_play_general_techniques_category_report(report, root, backup)
