"""CLI for the reviewed play declarer-probability category repair."""
...
def run(root: Path, backup: Path | None, apply: bool) -> None:
    report = build_play_probability_category_report(root)
    ...
    apply_play_probability_category_report(report, root, backup)
