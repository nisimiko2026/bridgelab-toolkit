...
PHASE = "17I"
BASELINE_PHASE = "17H"
CANDIDATE = "Restricted Choice Contract Enrichment Audit"
...
def run_audit() -> Phase17IResult:
    ...
    # Phase 17I is a conservative contract-enrichment audit. These booleans
    ...
    return Phase17IResult(
        ...
        gates=gates,
        phase17j_direction="RESTRICTED_CHOICE_CONTRACT_ENRICHMENT",
    )
