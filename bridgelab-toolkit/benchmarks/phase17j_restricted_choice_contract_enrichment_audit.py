...
def run_audit() -> Phase17JResult:
    ...
    # Phase 17J is a conservative contract-enrichment audit. These booleans
    ...
    return Phase17JResult(
        ...
        gates=gates,
        phase17k_direction="RESTRICTED_CHOICE_CONTRACT_ENRICHMENT",
    )
