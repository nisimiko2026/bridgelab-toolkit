...
def run_audit() -> Phase17HResult:
    ...
    # Phase 17H is a conservative gap-resolution audit. These booleans
    ...
    return Phase17HResult(
        ...
        gates=gates,
        phase17i_direction="RESTRICTED_CHOICE_CONTRACT_ENRICHMENT",
    )
