"""Safe Phase 3A Batch 3.3z Opening Principles category normalization."""
...
ARTICLE = "bidding/principles/bidding-fundamentals/rule-of-22.md"
REQUIRED_TAGS = ["opening", "opening principles", "principles"]
REVIEWED_CATEGORY_NORMALIZATION_BATCH3_3Z = {ARTICLE: REQUIRED_TAGS}
OBSERVED_CATEGORY = "Opening Principles"
...
def build_category_normalization_batch3_3z_report(root: Path) -> CategoryNormalizationReport:
    ...
    reviewed_family = set(REVIEWED_CATEGORY_NORMALIZATION_BATCH3_3Z)
    if observed_family not in (reviewed_family, set()):
        ...
        raise RuntimeError(
            "Reviewed Opening Principles family completeness mismatch: "
    ...
    if (
        tags != REQUIRED_TAGS
        or "opening principles" not in REQUIRED_TAGS
...
def apply_category_normalization_batch3_3z_report(
