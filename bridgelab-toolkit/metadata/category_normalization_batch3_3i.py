"""Safe Phase 3A Batch 3.3i natural-bidding category normalization."""
...
REVIEWED_CATEGORY_NORMALIZATION_BATCH3_3I = {
    "bidding/natural-bids/opening-bids/1-diamond.md": [
        "acol",
        "competitive",
        "cue bid",
        "double",
    ...
    "bidding/natural-bids/opening-bids/1-heart.md": [
        "acol",
        "competitive",
        "cue bid",
        "double",
    ...
    "bidding/natural-bids/opening-bids/1-spade.md": [
        "acol",
        "competitive",
        "cue bid",
        "double",
    ...
    "bidding/natural-bids/opening-bids/1nt-opening.md": [
        "acol",
        "blackwood",
        "competitive",
        "gerber",
    ...
    "bidding/natural-bids/opening-bids/2-clubs.md": [
        "acol",
        "blackwood",
        "competitive",
        "cue bid",
    ...
    "bidding/natural-bids/opening-bids/2nt-opening.md": [
        "acol",
        "blackwood",
        "competitive",
        "gerber",
    ...
    "bidding/natural-bids/opening-bids/four-level-preempts.md": [
        "acol",
        "competitive",
        "double",
        "forcing",
    ...
    "bidding/natural-bids/opening-bids/opening-bids-overview.md": [
        "acol",
        "forcing",
        "lead",
        "natural bidding",
    ...
    "bidding/natural-bids/opening-bids/opening-requirements.md": [
        "acol",
        "competitive",
        "lead",
        "natural bidding",
    ...
    "bidding/natural-bids/opening-bids/three-level-preempts.md": [
        "acol",
        "competitive",
        "double",
        "forcing",
    ...
    "bidding/natural-bids/opening-bids/weak-two-bids.md": [
        "acol",
        "competitive",
        "flannery",
        "forcing",
    ...
    "bidding/natural-bids/rebids/jump-rebids.md": [
        "acol",
        "competitive",
        "forcing",
        "natural bidding",
    ...
    "bidding/natural-bids/rebids/opener-after-1nt.md": [
        "acol",
        "blackwood",
        "competitive",
        "gerber",
    ...
    "bidding/natural-bids/rebids/opener-after-2nt.md": [
        "acol",
        "blackwood",
        "competitive",
        "gerber",
    ...
    "bidding/natural-bids/rebids/opener-after-major.md": [
        "acol",
        "forcing",
        "jacoby",
        "natural bidding",
    ...
    "bidding/natural-bids/rebids/opener-after-minor.md": [
        "acol",
        "forcing",
        "natural bidding",
        "natural-bids",
    ...
    "bidding/natural-bids/rebids/opening-rebids.md": [
        "acol",
        "blackwood",
        "forcing",
        "natural bidding",
    ...
    "bidding/natural-bids/rebids/rebids-after-preempts.md": [
        "acol",
        "competitive",
        "cue bid",
        "double",
    ...
    "bidding/natural-bids/rebids/responder-rebids.md": [
        "acol",
        "blackwood",
        "competitive",
        "cue bid",
    ...
    "bidding/natural-bids/rebids/reverse-bid.md": [
        "acol",
        "forcing",
        "natural bidding",
        "natural-bids",
...
OBSERVED_CATEGORY = "Natural Bidding"
...
def build_category_normalization_batch3_3i_report(
    root: Path,
) -> CategoryNormalizationReport:
    """Build the exact reviewed 20-file batch entirely in memory."""

    root = root.resolve()
    actions: list[CategoryNormalizationAction] = []
    for article, required_tags in sorted(
        REVIEWED_CATEGORY_NORMALIZATION_BATCH3_3I.items()
    ):
        ...
        if (
            tags != required_tags
            or "natural bidding" not in required_tags
    ...
    return CategoryNormalizationReport(
        selected_files=len(REVIEWED_CATEGORY_NORMALIZATION_BATCH3_3I),
        actions=tuple(actions),
    )


def apply_category_normalization_batch3_3i_report(
